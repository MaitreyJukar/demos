...
import * as PlayerModelPkg from "./../g-6-8-player/src/g-6-8-player-model";
import * as BasePlayerViewPkg from "./../g-6-8-player/src/g-6-8-player-view";
import * as InitPlayerPkg from "./../g-6-8-player/src/init-player";
...
const partialTemplates: { [x: string]: HandlebarsTpl } = {
    controls: require("./../g-6-8-player/tpl/partials/components/controls.hbs") as HandlebarsTpl,
    custom: require("./../g-6-8-player/tpl/partials/components/custom.hbs") as HandlebarsTpl,
    desmos: require("./../g-6-8-player/tpl/partials/components/desmos.hbs") as HandlebarsTpl,
    html: require("./../g-6-8-player/tpl/partials/components/html.hbs") as HandlebarsTpl,
    image: require("./../g-6-8-player/tpl/partials/components/image.hbs") as HandlebarsTpl,
    learnosity: require("./../g-6-8-player/tpl/partials/components/learnosity.hbs") as HandlebarsTpl,
...
const questionTemplate: (attr?: KeyValue) => string = require("./../g-6-8-player/tpl/partials/question.hbs");
