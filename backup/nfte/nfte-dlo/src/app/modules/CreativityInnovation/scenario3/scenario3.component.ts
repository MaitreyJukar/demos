...
export class Scenario3Component extends BaseComponent implements AfterViewInit, OnInit {
  ...
  ngOnInit() {
    ...
    this.dndModel1 = new DNDModel(this.data['scenes'][3]);
    this.dndModel2 = new DNDModel(this.data['scenes'][4]);
  ...
  previousClicked() {
    ...
    if (this.scenesBoolean[1] || this.scenesBoolean[2]) {
      this.videoCompleted = false;
      setTimeout(() => {
