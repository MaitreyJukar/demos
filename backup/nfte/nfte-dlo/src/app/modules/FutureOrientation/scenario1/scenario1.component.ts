...
export class Scenario1Component extends BaseComponent implements OnDestroy, OnInit, AfterViewInit {
  ...
  constructor(el: ElementRef, private router: Router, private activatedRoute: ActivatedRoute, private cdr: ChangeDetectorRef, private browser: BrowserCompatibilityService,
    private resizeService: WindowResizeService, keyboardService: KeyboardService) {
    super();
