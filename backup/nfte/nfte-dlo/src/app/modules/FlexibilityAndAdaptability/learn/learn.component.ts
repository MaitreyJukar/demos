...
@Component({
  selector: 'app-faa-learn',
  styleUrls: ['./learn.component.scss'],
  templateUrl: './learn.component.html'
})
export class LearnFAAComponent extends BaseComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    if (this.browser.isFireFox) {
      document.body.classList.add('faa-body');
    }
  ...
  ngOnDestroy() {
    if (this.browser.isFireFox) {
      document.body.classList.remove('faa-body');
    }
