...
(function() {
    ...
    MathUtilities.Components.CanvasAcc = {
        "Models": {},
        "Views": {},
        "Collections": {}
    };

    MathUtilities.Components.CanvasAcc.Models.CanvasAcc = Backbone.Model.extend({
        "defaults": function() {
            return {
                /* Stores type to be deal with canvas
                 * @default MathUtilities.Components.CanvasAcc.Models.CanvasAcc.TYPE.NAVIGATE_ITEM
                 * @property type
                 * @type {String}
                 */
                "type": MathUtilities.Components.CanvasAcc.Models.CanvasAcc.TYPE.NAVIGATE_ITEM,
                ...
                "setAccMessageObject": {
                    /* this will trigger event in view to change acc message,
         ...
         */
        "initialize": function() {
            var collectionCanvasItems = new MathUtilities.Components.CanvasAcc.Collections.CanvasItems();
         ...
         *
         */
        "_lineDrawingBoolchange": function() {
            if (this.get('isToolLineDrawingOn')) {
                this.set('paperItems', []);
            }
         ...
         * @public
         */
        "setCollectionCanvasItems": function(items, isKeepCurrentItem) {

            var collectionCanvasItems = this.get('collectionCanvasItems'),
                isCurrentItemSet = false,
                index,
                currentPaperItem,
                item, CanvasItem = MathUtilities.Components.CanvasAcc.Models.CanvasItem,
            ...
            if (!isCurrentItemSet && collectionCanvasItems.getCurrentItem()) {
                currentPaperItem = collectionCanvasItems.length > 0 ? collectionCanvasItems.getCurrentItem().get('paperItem') : null;
                if (currentPaperItem) {
        ...
        /* Find given paper item in collection and set it as current item
         * @method setCollectionCurrentItem
         * @param {object} currentPaperItem
         * @public
         */
        "setCollectionCurrentItem": function(currentPaperItem) {
            var collectionCanvasItems = this.get('collectionCanvasItems'),
                item = collectionCanvasItems.where({
                    "paperItem": currentPaperItem
                });
         ...
         * @public
         */
        "getCollectionCurrentItemIndex": function() {
