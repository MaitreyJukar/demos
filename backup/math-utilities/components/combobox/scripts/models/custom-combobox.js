(function () {
    'use strict';
    MathUtilities.Components.Combobox = {};

    MathUtilities.Components.Combobox.Models = {};
    ...
    * @namespace MathUtilities.Components.Models
    */
    MathUtilities.Components.Combobox.Models.CustomCombobox = Backbone.Model.extend({
        defaults: function () {
            return {
                /**
                * @property element
                ...
                * @defaults false
                */
                'isHintEnabled': true//show/hide hint for comboBoxes
            }
        },
        /**
        * setter for element
