(function () {
    ...
    * @constructor
    */
    MathInteractives.Interactivities.MiniGolf.Views.LineUtility = Backbone.View.extend({},
    {
        /* ///////////////////////////////////////////////////////////
        ...
        ************************************************************
        ...
        AngleBetweenLineAndPointF: function (ptLineStart, ptLineEnd, ptOutSide) {
        ...
        GetDistBetweenPointFs: function (pt1, pt2) {
            return Math.sqrt(Math.pow(pt1.x - pt2.x, 2) + Math.pow(pt1.y - pt2.y, 2));
        },

        GetvarOnLineUsingDistance: function (ptfLineStart, ptfLineEnd, dDistance, dOffsetAngle, bDistFromStartPt) {
        ...
        GetvarOnLineUsing_U_Value: function (ptLineStart, ptLineEnd, u) {
        ...
        GetRotatedvar: function (ptf, cptf, dRotationInDegree) {
            var outPt = { x: 0, y: 0 };
        ...
        getAngleWithXAxis: function (point, refPoint) {
            var x1 = refPoint.x,
                y1 = refPoint.y,
                x2 = point.x,
                y2 = point.y,
        ...
        ReflectvarToTheLine: function (ptToReflect, ptLineStart, ptLineEnd) {
        ...
        GetNormalvar: function (ptNotOnLine, ptLineStart, ptLineEnd) {
        ...
        GetDistBetweenvars: function (pt1, pt2) {
            return Math.sqrt(Math.pow(pt1.x - pt2.x, 2) + Math.pow(pt1.y - pt2.y, 2));
        },
        ...
        GetInterSectionOfTwoLines: function (ptStartLine_1, ptEndLine_1, ptStartLine_2, ptEndLine_2, btwnLine1, btwnLine2) {
        ...
        Get_LineU_ForPointF: function (ptLineStart, ptLineEnd, ptOnLine) {
            var x1 = ptLineStart.x;
            var y1 = ptLineStart.y;
            var x2 = ptLineEnd.x;
            var y2 = ptLineEnd.y;
