...
(function (MathUtilities) {
    ...
    MathUtilities.Components.Manager.Models.Message = Backbone.Model.extend({
        ...
        _updateMessages: function () {
            //TODO Handle messages for touch devices. 
            ...
            isAccTextSame = (selfAccLocType !== null && selfAccLocType !== undefined) ? selfAccLocType : parentAccLocType;
            if (isAccTextSame) {
                if (message.loc !== undefined && message.loc !== '') {
                    message.acc = message.loc;
                } else if (message.acc !== undefined && message.acc !== '') {
                    message.loc = message.acc;
                }
            }
            return this;
        }
