(function () {
    ...
    */
    MathInteractives.Common.Components.Models.CustomSpinner = Backbone.Model.extend({
        ...
        defaults: function () {
            return {
                ...
                * @property emptySpinnerPlaceHolders
                ...
                * @property onIncreasePlaceHolders
                * @type Array of Strings
                * @default null
                */
                ...
                * @property onDecreasePlaceHolders
                * @type Array of Strings
                * @default null
                */
        ...
        */
        initialize: function initialize() {
            ...
            if (this.get('emptySpinnerPlaceHolders') === null) {
                this.setEmptySpinnerPlaceHolders([MathInteractives.global.CustomSpinner.MIN_VAL, MathInteractives.global.CustomSpinner.MAX_VAL]);
            }
            if (this.get('defaultPlaceHolders') === null) {
                this.setDefaultPlaceHolders([MathInteractives.global.CustomSpinner.CURR_VAL]);
            }
            if (this.get('minLimitPlaceHolders') === null) {
                this.setMinLimitPlaceHolders([MathInteractives.global.CustomSpinner.MIN_VAL]);
            }
            if (this.get('maxLimitPlaceHolders') === null) {
                this.setMaxLimitPlaceHolders([MathInteractives.global.CustomSpinner.MAX_VAL]);
            }
            if (this.get('onIncreasePlaceHolders') === null) {
                this.setOnIncreasePlaceHolders([MathInteractives.global.CustomSpinner.CURR_VAL]);
            }
            if (this.get('onDecreasePlaceHolders') === null) {
                this.setOnDecreasePlaceHolders([MathInteractives.global.CustomSpinner.CURR_VAL]);
            }
        ...
        * @method setButtonState
        * @param {Boolean} isBottomAligned Buttons to be bottom aligned.
        * @public
        */
        ...
        * @param {String} emptySpinnerAccText Accessibility text for spinner text box when empty.
        * @public
        */
        ...
        * @param {String} emptyPlaceHolders Place holders for the default accessibility text
        * @public
        */
        ...
        * @return {String} Place holders for the default accessibility text
        * @public
        */
        ...
        * @param {String} defaultPlaceHolders Place holders for the default accessibility text
        * @public
        */
        ...
        * @param {String} minLimitAccText Minimum limit accessibility text for the input box
        * @public
        */
        ...
        * @param {String} minLimitPlaceHolders Place holders for the minimum limit accessibility text
        * @public
        */
        ...
        * @return {String} Place holders for the minimum limit accessibility text
        * @public
        */
        ...
        * @param {String} maxLimitAccText Maximum limit accessibility text for the input box
        * @public
        */
        ...
        * @param {String} maxLimitPlaceHolders Place holders for the maximum limit accessibility text
        * @public
        */
        ...
        * @return {String} Place holders for the maximum limit accessibility text
        * @public
        */
        ...
        * @param {String} onIncreaseAccText Accessibility text for the input box when the increase button is pressed
        * @public
        */
        ...
        * @param {String} onIncreasePlaceHolders Place holders for the on-increase accessibility text
        * @public
        */
        ...
        * @return {String} Place holders for the on-increase accessibility text
        * @public
        */
        ...
        * @param {String} onDecreaseAccText Accessibility text for the input box when the decrease button is pressed
        * @public
        */
        ...
        * @param {String} onDecreasePlaceHolders Place holders for the on-decrease accessibility text
        * @public
        */
        ...
        * @return {String} Place holders for the on-decrease accessibility text
        * @public
        */
        ...
        * @param {String} textAccId Text element's accessibility id
        * @private
        */
        ...
        * @param {String} upArrowAccId Up arrow element's accessibility id
        * @private
        */
        ...
        * @param {String} downArrowAccId Down arrow element's accessibility id
        * @private
        */
        ...
        * @method _setTabIndex
        * @param {Integer} tabIndex Text element's tab index
        * @private
        */
        ...
        * @param {Integer} upArrowTabIndex Up arrow element's tab index
        * @private
        */
        ...
        * @param {Integer} downArrowTabIndex Down arrow element's tab index
        * @private
        */
        ...
        * @param {Object} textAccObj Text element's accessibility object
        * @private
        */
        ...
        * @param {Object} textAccObj Up arrow element's accessibility object
        * @private
        */
        ...
        * @param {Object} textAccObj Down arrow element's accessibility object
        * @private
        */
