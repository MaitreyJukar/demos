(function (MathInteractives) {
    'use strict';
    MathInteractives.Common.Components.Models.MathUtilitiesGraphNew.EquationEngine.MathFunctions = Backbone.Model.extend({}, {
        ...
        */
        ...
        sumProductPrototype: function sum(pivot, start, end, expression, param, constants) {
            var findFactorialString = '" + MathInteractives.Common.Components.Models.MathUtilitiesGraphNew.EquationEngine.MathFunctions.findFactorialString + "';
            var gammaFunctionString='" + MathInteractives.Common.Components.Models.MathUtilitiesGraphNew.EquationEngine.MathFunctions._gammaFunctionString + "';
