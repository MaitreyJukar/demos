...
templates['tableSortNotation'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "﻿<div id=\"";
  if (helper = helpers.columnID) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.columnID); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\" class=\"tbl-header-sort-container\">\r\n	<div class=\"tbl-header-up-arrow-container\">\r\n		<div class=\"tbl-header-up-arrrow-image\"></div>\r\n	</div>\r\n	<div class=\"tbl-header-down-arrow-container\">\r\n		<div class=\"tbl-header-down-arrrow-image\"></div>\r\n	</div>\r\n</div>";
  return buffer;
  });
})();