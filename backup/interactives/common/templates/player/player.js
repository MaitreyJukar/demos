...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  else { stack1 = depth0.bookId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\"  texthelpcmd2=\"pageid:";
  if (stack1 = helpers.pageId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.pageId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
